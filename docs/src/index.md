...
hero:
  name: Chmy.jl Docs
  text: Finite difference computations on CPUs and GPUs
  tagline: A backend-agnostic toolkit for finite difference computations.
  actions:
    - theme: alt
      text: View on GitHub
...
[Chmy.jl](https://github.com/PTsolvers/Chmy.jl) (pronounce *tsh-mee*) is a **backend-agnostic toolkit for finite difference computations** on multi-dimensional computational grids.
